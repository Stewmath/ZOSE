...
namespace ZOSE
{
    ...
    {
        const string Title = "ZOSE - Zelda Oracles Script Editor (Drenn's Update v0.8.00 beta)";
...
//             this.gb.WriteBytes(0x30000, ZOSE.Properties.Resources.bankc);
            ...
            this.gb.WriteBytes(0x2be09, new byte[] {
                    0x1e, 0x44, 0x1a, 0xb7, 0x20, 0x10, 0x3c, 0x12,
                    0x1e, 0x42, 0x1a, 0x21, 0x00, 0x40, 0xdf, 0xd7,
                    0xcd, 0x39, 0x3f, 0xcd, 0x44, 0x25, 0xcd, 0x52,
                    0x25, 0xda, 0x05, 0x3b, 0xc9
                    });

            // Interaction 72 pointer
            this.gb.WriteByte(0x3c6f, 9);
            this.gb.WriteByte(0x3c70, 0x7e);

            // Pointer to script opcode $7D
            this.gb.WriteBytes(0x30103, new byte[] { 0x2d, 0x3f });

            // Script opcode $7D (jump table)
            this.gb.WriteBytes(0x3f2d, new byte[] {
                    0xe1, 0x23, 0x2a, 0xe5, 0x21, 0xf3, 0x7f, 0xdf,
                    0x2a, 0x66, 0x6f, 0xe9
                    });

            // Interaction 72 script loading function
            this.gb.WriteBytes(0x3f39, new byte[] {
                    0xf0, 0x97, 0xf5, 0x3e, 0xff, 0xe0, 0x97, 0xea,
                    0x22, 0x22, 0xcd, 0xf0, 0x25, 0xf1, 0xe0, 0x97,
                    0xea, 0x22, 0x22, 0xc9
                    });
            ...
            // Unused (used to be part of interaction update routine)
        ...
        {
            // Jump3Byte
            this.PatchOpcode(0, 0x33f93);
            this.gb.WriteBytes(0x33f93, new byte[] {
                    0xe1, 0xcd, 0xf0, 0x25, 0xb7, 0xc9, 
                    });

            // JumpRoomFlag
            this.PatchOpcode(1, 0x33f99);
            this.gb.WriteBytes(0x33f99, new byte[] {
                    0xe1, 0x2a, 0x47, 0xe5, 0xcd, 0x7d, 0x19, 0xe1,
                    0xa0, 0x20, 0xf0, 0x23, 0x23, 0x23, 0x00, 0xc9
                    });

            // Jump3ByteMC
            this.PatchOpcode(2, 0x33fa9);
            this.gb.WriteBytes(0x33fa9, new byte[] { 
                    0xe1, 0x2a, 0x46, 0x4f, 0x0a, 0x23, 0xbe, 0x23,
                    0x28, 0xe1, 0x18, 0xef, 
                    });

            // JumpRoomFlagO
            this.PatchOpcode(3, 0x33fb5);
            this.gb.WriteBytes(0x33fb5, new byte[] { 
                    0xe1, 0x2a, 0x47, 0x2a, 0xe5, 0xcd, 0x8a, 0x19,
                    0xe1, 0xa6, 0x23, 0x20, 0xd2, 0x18, 0xe0, 
                    });

            // UnsetRoomFlag
            this.PatchOpcode(4, 0x33fc4);
            this.gb.WriteBytes(0x33fc4, new byte[] {
                    0xe1, 0x2a, 0x4f, 0x2a, 0x47, 0x2a, 0xe5, 0xcd,
                    0x8a, 0x19, 0x79, 0xa6, 0x77, 0xe1, 0x00, 0xc9
                    });
