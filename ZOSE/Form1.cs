...
//             this.gb.WriteBytes(0x30000, ZOSE.Properties.Resources.bankc);
        ...
        public void PatchOtherOpcodes(bool write)
        {
            ...
            this.gb.WriteBytes(0x33f93, new byte[] {
                    0xe1, 0xc3, 0xf0, 0x25, 0xe1, 
                    });

            // JumpRoomFlag
            this.PatchOpcode(1, 0x33f97);
            this.gb.WriteBytes(0x33f97, new byte[] {
                    0xe1, 0x2a, 0x47, 0xe5, 0xcd, 0x7d, 0x19, 0xe1,
                    0xb8, 0x28, 0xf2, 0x23, 0x23, 0x23, 0x37, 0xc9
                    });

            // Jump3ByteMC
            this.PatchOpcode(2, 0x33fa7);
            this.gb.WriteBytes(0x33fa7, new byte[] { 
                    0xe1, 0x2a, 0x46, 0x4f, 0x0a, 0x23, 0xbe, 0x23,
                    0x28, 0xe3, 0x18, 0xef, 
                    });

            // JumpRoomFlagO
            this.PatchOpcode(3, 0x33fb3);
            this.gb.WriteBytes(0x33fb3, new byte[] { 
                    0xe1, 0x2a, 0x47, 0x2a, 0xe5, 0xcd, 0x8a, 0x19,
                    0xe1, 0xa6, 0x23, 0x20, 0xd4, 0x18, 0xe0, 
                    });

            // UnsetRoomFlag
            this.PatchOpcode(4, 0x33fc2);
            this.gb.WriteBytes(0x33fc2, new byte[] {
                    0xe1, 0x2a, 0x4f, 0x2a, 0x47, 0x2a, 0xe5, 0xcd,
                    0x8a, 0x19, 0x79, 0xa6, 0x77, 0xe1, 0x37, 0xc9
                    });
